...
const Navbar = () => {
  ...
  bg-clip-text text-transparent"
      ...
      <motion.nav
        ...
        className="bg-[#0a0a0a] text-white px-8 py-5 flex items-center justify-between font-sans shadow-xl"
      >
        {/* Logo */}
  ...
  bg-clip-text text-transparent"
        ...
        <div className="hidden md:flex items-center gap-10 text-[15px] font-normal">
          ...
          <NavLink to="/login" className="flex items-center gap-2 group">
            <div className="w-6 h-6 bg-[#FF5F5F] rounded-full flex items-center justify-center group-hover:scale-110 transition">
              <span className="text-[12px]">👤</span>
            </div>
            <span className="text-[#FF5F5F]">Log In</span>
          </NavLink>
